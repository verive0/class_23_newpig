...
from class23_api_frame.common.public import filepath
class Logger:
    def __init__(self):

        log_folder =os.path.split(filepath('log'))[0]
...
def trace_log(func):
    def wrapper(*args, **kwargs):
        log.debug('Function:[{}], args:{}, kwargs:{}'.format(func.__name__, args, kwargs))
